...
![Laravel Version](https://img.shields.io/badge/Laravel-13.x-red?style=for-the-badge&logo=laravel)
![PHP Version](https://img.shields.io/badge/PHP-8.4%2B-blue?style=for-the-badge&logo=php)
...
```bash
git clone https://github.com/Hadgun/Tugasbesar_kelompok4_WEB2_Minimarket.git
cd Tugasbesar_kelompok4_WEB2_Minimarket
```
...
DB_HOST=127.0.0.1
DB_PORT=3306
DB_DATABASE=PWL_web2_Minimarket_Kelompok4
DB_USERNAME=root
DB_PASSWORD=
```
...
```sql
CREATE DATABASE PWL_web2_Minimarket_Kelompok4 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```
...
| Didistribusikan secara publik untuk referensi pembelajaran | ✅ Diizinkan |
...
| No | Nama | NPM |
|----|------|-----|
| 1 | M. Hadi Gunawan | 5520123130 |
| 2 | Muhammad Ikhsan | 5520123134 |
| 3 | Alwi Akbari Muztaba | 5520123114 |
